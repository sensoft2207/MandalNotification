...
import com.android.mandalchat.ui.FriendsFragment;
import com.android.mandalchat.ui.LoginActivity;
import com.android.mandalchat.ui.UserProfileFragment;

import java.util.ArrayList;
import java.util.List;

import static com.android.mandalchat.ui.FriendsFragment.dataListFriend;
   ...
   // LinearLayout ln_top;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("Callway");
        }

        viewPager = (ViewPager) findViewById(R.id.viewpager);
        //ln_top = (LinearLayout) findViewById(R.id.ln_top);
        //searchView = (SearchView) findViewById(R.id.searchView);
       // floatButton = (ImageView) findViewById(R.id.fab);
        initTab();
        initFirebase();
    }
...
//                ServiceUtils.stopServiceFriendChat(MainActivity.this.getApplicationContext(), false);
                /*if (adapter.getItem(position) instanceof FriendsFragment) {
                    ...
                    floatButton.setImageResource(R.drawable.add_user);
                } else {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Callway buddy version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
