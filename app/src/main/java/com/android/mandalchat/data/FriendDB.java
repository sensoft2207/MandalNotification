...
public final class FriendDB {
    ...
    public long addFriend(Friend friend) {
        ...
        values.put(FeedEntry.COLUMN_TOKEN, friend.tokenn);
        values.put(FeedEntry.COLUMN_JOINING, friend.joining);
        values.put(FeedEntry.COLUMN_PROFESSION, friend.profession);
        values.put(FeedEntry.COLUMN_MOBILE, friend.mobile);
...
// you will actually use after this query.
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                friend.tokenn = cursor.getString(4);
                friend.joining = cursor.getString(5);
                friend.profession = cursor.getString(6);
                friend.mobile = cursor.getString(7);
                friend.avata = cursor.getString(8);
    ...
    public static class FeedEntry implements BaseColumns {
        ...
        static final String COLUMN_TOKEN = "not_token";
        static final String COLUMN_JOINING = "joining";
        static final String COLUMN_PROFESSION = "profession";
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + FeedEntry.TABLE_NAME + " (" +
                    ...
                    FeedEntry.COLUMN_TOKEN + TEXT_TYPE + COMMA_SEP +
                    FeedEntry.COLUMN_JOINING + TEXT_TYPE + COMMA_SEP +
                    FeedEntry.COLUMN_PROFESSION + TEXT_TYPE + COMMA_SEP +
    ...
    private static class FriendDBHelper extends SQLiteOpenHelper {
        ...
        static final String DATABASE_NAME = "Callway.db";
