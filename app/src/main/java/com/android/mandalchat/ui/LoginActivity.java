...
import com.android.mandalchat.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    String joining, profession,mobile;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == StaticConfig.REQUEST_CODE_REGISTER && resultCode == RESULT_OK) {
            ...
            joining = data.getStringExtra(StaticConfig.STR_EXTRA_JOINING);
            profession = data.getStringExtra(StaticConfig.STR_EXTRA_PROFESSION);
            mobile = data.getStringExtra(StaticConfig.STR_EXTRA_MOBILE);

            Log.e("@@joining",joining);
    ...
    class AuthUtils {
        ...
        void createUser(String email, String password) {
            waitingDialog.setIcon(R.drawable.smartphone)
                    .setTitle("Please wait buddy...")
        ...
        void saveUserInfo() {
            FirebaseDatabase.getInstance().getReference().child("user/" + StaticConfig.UID).addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    userInfo.tokenn = (String) hashUser.get("not_token");
                    userInfo.joining = (String) hashUser.get("joining");
                    userInfo.profession = (String) hashUser.get("profession");
                    ...
                    FirebaseDatabase.getInstance().getReference().child("user/" + user.getUid()).child("not_token").setValue(token);
